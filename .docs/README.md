...
这套文档把本仓库当作一门小型教材来讲。目标是帮你建立一张稳定的脑图：什么是 LLM Agent，Claude Agent SDK 到底暴露了什么抽象，这个仓库为什么适合教学，以及你怎样在这个基线上继续做实验、做系统、做论文。
...
如果你在 02 或 03 里觉得名词密度偏高，先跳到 [14-glossary.md](14-glossary.md) 扫一遍，再回来读会顺很多。
