...
一个研究生最关心的问题通常不是“我看懂了没有”，而是“我能不能在这上面做出自己的东西”。答案是可以，而且这仓库很适合作为起点。
...
../INPLUSLAB_BOOTSTRAP.md 已经给了很好的建议：在单独目录里建立自己的 extension layer，例如 packages、src 或 experiments，而不是直接把上游快照改成一团混合体。
